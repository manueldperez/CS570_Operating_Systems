...
int getword(char *w)
{
    ...
    extern int AMPERSANDFLAG;	// 1 if we encounter ampersand character
    extern int METAFLAG;	// set to 1 when returning a metacharacter
